...
export class ProfessorAreaRepository {
  ...
  private repo = AppDataSource.getRepository(ProfessorArea);
  ...
  async findByProfessor(idProfessor: number): Promise<ProfessorArea[]> {
  ...
  async findByProfessorAndArea(idProfessor: number, idArea: number): Promise<ProfessorArea | null> {
  ...
  async create(idProfessor: number, idArea: number): Promise<ProfessorArea> {
  ...
  async update(id: number, idArea: number): Promise<ProfessorArea | null> {
