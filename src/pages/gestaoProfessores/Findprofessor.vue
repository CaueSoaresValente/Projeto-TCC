...
<template>
  ...
  <v-container class="max-w-[1400px] mx-auto">
    <!-- Título e seleção de turma -->
    <div class="mb-8">
      <h1 class="text-3xl font-bold mb-2">Gestão de Professores</h1>
      <p class="text-gray-500 text-sm mb-6">
        Selecione uma turma e clique em um slot da grade para buscar e designar
        professores.
      </p>
